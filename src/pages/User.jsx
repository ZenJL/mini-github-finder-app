...
function User() {
  ...
  // console.log(params)
  const paramsLogin = params.login;
  ...
  useEffect(() => {
    ...
    const getUserData = async () => {
      // refactor with axios
      const userData = await getUserAndRepos(paramsLogin);
      dispatch({type: 'GET_USER_AND_REPOS', payload: userData});

      // const userData = await getUser(paramsLogin);
      // // const userData = await getUser(params.login);
      // dispatch({type: 'GET_USER', payload: userData});

      // const userRepoData = await getUserRepos(paramsLogin);
      // // const userRepoData = await getUserRepos(params.login);
      // dispatch({type: 'GET_REPOS', payload: userRepoData});
    }

    getUserData();
  }, [dispatch, paramsLogin])
